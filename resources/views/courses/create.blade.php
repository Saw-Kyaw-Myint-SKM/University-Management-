                    ...
                    <form method="POST" action="{{ route('courses.store') }}">
                                ...
                                <div>
                                    ...
                                    <select id="credits" name="credits"
                                        ...
                                        @foreach(range(1, 6) as $c)
                                            <option value="{{ $c }}" {{ old('credits') == $c ? 'selected' : '' }}>
                        ...
                        <div class="mb-8">
                            ...
                            <textarea id="description" name="description" rows="4"
                                ...
                                class="w-full px-4 py-3 border @error('description') border-red-400 bg-red-50 @else border-gray-300 @enderror rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 resize-none">{{ old('description') }}</textarea>
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit" class="flex items-center px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold rounded-xl hover:from-emerald-600 hover:to-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
